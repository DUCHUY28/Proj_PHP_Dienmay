...
if(isset($_GET['id'])){
	...
	$id = '';
						...
						$sql_cate = mysqli_query($connect,"SELECT * FROM tbl_category,tbl_sanpham 
						where 	tbl_category.category_id=tbl_sanpham.category_id and tbl_sanpham.category_id='$id'
						 order by tbl_sanpham.category_id DESC");
						 $sql_cate_title = mysqli_query($connect,"SELECT * FROM tbl_category,tbl_sanpham 
						 where 	tbl_category.category_id=tbl_sanpham.category_id and tbl_sanpham.category_id='$id'
						  order by tbl_sanpham.category_id DESC");
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img style="width:150px;" src="uploads/<?php echo $row_sanpham['sanpham_image']?>" alt="">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="?quanly=<?php echo $row_sanpham['sanpham_id'] ?>">
