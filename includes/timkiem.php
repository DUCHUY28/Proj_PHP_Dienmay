...
if(isset($_POST['search_button'])){
	$key_word = $_POST['search_product'];
						$sql_product = mysqli_query($connect,"SELECT * FROM tbl_sanpham 
						where tbl_sanpham.sanpham_name like '%$key_word%' 
...
<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">Từ khóa tim kiếm : <?php echo $title ?></h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
