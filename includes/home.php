		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						<?php
						$sql_cate_home = mysqli_query($connect,"SELECT * FROM tbl_category order by category_id DESC");
					...
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="f-grid py-2">
							...
							<div class="box-scroll">
								<div class="scroll">
									<?php
									$sql_product_sidebar = mysqli_query($connect,
									"SELECT * FROM tbl_sanpham where sanpham_hot='0' order by sanpham_id DESC");
